...
echo Get unique reads
outPrefix='/mnt/isilon/xing_lab/xuy5/GLIMMPS/Geuvadis/CEU'
mkdir -p $outPrefix/sam_unique
mkdir -p $outPrefix/bam_unique
...
samtools view -b -o $outPrefix'/bam_unique/'$1.tmp.bam $outPrefix'/sam_unique/'$1.unique.sam 
samtools sort -o $outPrefix'/bam_unique/'$1.unique.bam $outPrefix'/bam_unique/'$1.tmp.bam
samtools index $outPrefix'/bam_unique/'$1.unique.bam
rm $outPrefix'/bam_unique/'$1.tmp.bam
echo $1	Done >> 2.unique.sam.log
